function [A, r] = analy_green(z, zp, L)
%ANALY_GREEN Analytical solution for Green's function
%   Calculates the analytical solution for the Green's function of:
%     HS:half-space (2 half-spaces and one boundary)
%     PL:plate (2 half-spaces, one intermediate "plate" layer, 2 boundaries)
%     SW:sandwich (3 intermediate layers, 4 boundaries)
